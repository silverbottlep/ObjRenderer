...
inline GLuint loadShaders(const std::vector<std::string> &vertList,
                          const std::vector<std::string> &fragList) {
  char *vs, *fs;
...
inline GLuint loadShaders(const char *vert, const char *frag) {
  return loadShaders(std::vector<std::string>(1, vert),
                     std::vector<std::string>(1, frag));
}

inline GLuint loadShaders(const char *vert,
                          const std::vector<std::string> &fragList) {
