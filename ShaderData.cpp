...
void ShaderDataPhong::send2shader(GLuint shaderProgID) const {
  ...
  glUniform3fv(glGetUniformLocation(shaderProgID, "kd"), 1, (float *)&kd);
  glUniform3fv(glGetUniformLocation(shaderProgID, "ka"), 1, (float *)&ka);
  glUniform3fv(glGetUniformLocation(shaderProgID, "ks"), 1, (float *)&ks);
